...
The objective of this project is to implement a program that solves rubik’s cube using reinforcement learning. The starting point is the deep mind’s paper on atari games. Curriculum learning will be also considered.
\end{abstract}
